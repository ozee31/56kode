const socialIcons = {
  ...
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <path
      d="M6.335 5.144c-1.654 -1.199 -4.335 -2.127 -4.335 .826c0 .59 .35 4.953 .556 5.661c.716 2.463 3.13 2.75 5.444 2.369c-4.045 .665 -4.849 3.51 -2.647 5.406c1.313 1.13 2.298 1.294 3.156 .818c1.078 -.598 1.485 -2.128 2.491 -4.224c1.006 2.096 1.413 3.626 2.491 4.224c.858 .476 1.843 .312 3.156 -.818c2.202 -1.896 1.398 -4.741 -2.647 -5.406c2.314 .381 4.728 .094 5.444 -2.369c.206 -.708 .556 -5.071 .556 -5.661c0 -2.953 -2.68 -2.025 -4.335 -.826c-2.293 1.662 -4.76 5.024 -5.665 6.826c-.905 -1.802 -3.372 -5.164 -5.665 -6.826z"
    ></path>
  </svg>`,
};
